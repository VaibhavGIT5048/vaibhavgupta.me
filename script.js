...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:vwork825@gmail.com" style="color: #ffffff; text-decoration: none;">vwork825@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="./index.html" style="color: #ffffff; text-decoration: none;">Open Portfolio</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/VaibhavGIT5048" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/VaibhavGIT5048</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/vaibhav-gupta-4a11b0288/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/vaibhav-gupta-4a11b0288</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "vaibhav@gupta: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    role.textContent = "Statistical Data Analysis • AIML • Data Science";
    ...
    url.textContent = window.location.host || "portfolio";
